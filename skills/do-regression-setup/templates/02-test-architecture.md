...
**Subject = the built app, black-box:** specs are **whole-app user journeys** (login → … → outcome, cross-feature where the coverage map says so) driven through the real UI/API of the deployed/installed artifact — there are no component-level tests here, and nothing in this project imports app code.>
...
> **Search here before creating a screen-object**:
...
| Screen-object | App screen (04 screen map) | Path | Key actions |
|---------------|-----------------------------|------|-------------|
| <EntityListScreen> | <screen name in `04-app-under-test.md`> | <path> | <open, search, expectRow> |
